...
Source0  : https://cpan.metacpan.org/authors/id/H/HA/HAARG/Role-Tiny-2.002003.tar.gz
...
%prep
%setup -q -n Role-Tiny-2.002003
cd %{_builddir}/Role-Tiny-2.002003
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Role/Tiny.pm
/usr/lib/perl5/vendor_perl/5.30.3/Role/Tiny/With.pm
